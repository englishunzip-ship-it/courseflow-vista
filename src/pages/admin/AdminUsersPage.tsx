        ...
        <div className="bg-card border border-border rounded-xl overflow-hidden">
          ...
          <div className="p-4 sm:p-6 space-y-5 overflow-y-auto max-h-[60vh]">
            ...
            {rejectedReqs.length > 0 && (
              <div>
                <p className="text-xs text-muted-foreground font-medium uppercase mb-2">Rejected Enrollments</p>
                {rejectedReqs.map((req) => (
                  <div key={req.id} className="p-3 bg-destructive/5 border border-destructive/20 rounded-lg space-y-2 mb-2">
                    <div className="flex items-center gap-2">
